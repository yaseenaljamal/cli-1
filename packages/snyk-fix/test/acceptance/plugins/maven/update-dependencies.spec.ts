...
describe('fix single pom.xml projects', () => {
  ...
  it('fixes a simple project by upgrading inline', async () => {
    ...
    filesToDelete = [
      pathLib.join(workspacesPath, 'single-pom/simple-app/fixed-pom.xml'),
    ];

    const testResult = generateTestResult('maven');
  ...
  it('fixes a simple project with properties in the same file by upgrading the property', async () => {
    ...
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/app-with-properties/fixed-pom.xml',
      ),
    ];
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/app-with-properties/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
  ...
  it('fixes a simple project with dependencyManagement in the same file by upgrading the dependencyManagement', async () => {
    ...
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/app-with-dependency-management/fixed-pom.xml',
      ),
    ];
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/app-with-dependency-management/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
  ...
  it('fixes a simple project with dependencyManagement & properties in the same file by upgrading the properties', async () => {
    // Arrange
    const targetFile =
      'single-pom/app-with-properties-and-dependency-management/pom.xml';
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/app-with-properties-and-dependency-management/fixed-pom.xml',
      ),
    ];
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/app-with-properties-and-dependency-management/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
  ...
  it('fixes a simple project with comments & spacing issues by upgrading inline', async () => {
    ...
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/namespace-comments/fixed-pom.xml',
      ),
    ];
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/namespace-comments/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
  ...
  it('fixes a project with published parent by upgrading inline', async () => {
    ...
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/published-spring-boot-parent/fixed-pom.xml',
      ),
    ];

    const testResult = {
      ...generateTestResult('maven'),
      remediation: {
        unresolved: [],
        upgrade: {
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/published-spring-boot-parent/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
  ...
  it('fixes a project with parent version property by upgrading parent version', async () => {
    ...
    filesToDelete = [
      pathLib.join(
        workspacesPath,
        'single-pom/pom-parent-version/fixed-pom.xml',
      ),
    ];
    ...
    const expectedPom = fs.readFileSync(
      pathLib.resolve(
        workspacesPath,
        'single-pom/pom-parent-version/expected-pom.xml',
      ),
      'utf-8',
    );
    const fixedPom = fs.readFileSync(
